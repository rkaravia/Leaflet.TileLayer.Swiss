...
function editOnCodepen(layerId) {
  ...
  var codepenOptions = {
    css: css,
    css_external: 'https://cdn.jsdelivr.net/npm/leaflet@1.9.4/dist/leaflet.css',
    editors: '001',
    layout: 'left',
    ...
    js_external: [
      ...
      'https://cdn.jsdelivr.net/npm/leaflet-tilelayer-swiss@2.4.0/dist/Leaflet.TileLayer.Swiss.umd.js'
    ].join(';')
  };
